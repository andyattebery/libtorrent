...
DownloadMain::DownloadMain() :
  ...
  m_delegator.slot_chunk_find() = std::bind(&ChunkSelector::find, m_chunkSelector, placeholders::_1, placeholders::_2);
  m_delegator.slot_chunk_size() = std::bind(&FileList::chunk_index_size, file_list(), placeholders::_1);

  m_delegator.transfer_list()->slot_canceled()  = std::bind(&ChunkSelector::not_using_index, m_chunkSelector, placeholders::_1);
  m_delegator.transfer_list()->slot_queued()    = std::bind(&ChunkSelector::using_index, m_chunkSelector, placeholders::_1);
  m_delegator.transfer_list()->slot_completed() = std::bind(&DownloadMain::receive_chunk_done, this, placeholders::_1);
  m_delegator.transfer_list()->slot_corrupt()   = std::bind(&DownloadMain::receive_corrupt_chunk, this, placeholders::_1);
